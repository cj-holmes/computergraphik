...
set.seed(1) # original published graphic made with seed = 1
...
# Save 
ggsave("gravel/original/out/gravel.pdf", device="pdf", width=21.8, height=28, units="cm")
ggsave("gravel/original/out/gravel.png", device="png", width=21.8, height=28, units="cm")
...
ggsave("gravel/original/out/gravel-deviations.pdf", device="pdf", width=21.8, height=28, units="cm", bg="white")
...
d %>% 
  ggplot()+
  geom_lc(aes(x=xn, y=-yn, length=u, width=u, angle=angle, col=yn), 
          fill=NA, size=0.4)+
  coord_equal()+
  theme_void()+
...
# Save
ggsave("gravel/original/out/gravel-cividis.pdf", device="pdf", width=21.8, height=28, units="cm", bg="grey10")
ggsave("gravel/original/out/gravel-cividis.png", device="png", width=21.8, height=28, units="cm", bg="grey10")
